...
public class CarCerActivity extends AppCompatActivity {
    ...
    private void saveID() {
        ...
        final StorageReference reference1 = storageReference.child(value).child(System.currentTimeMillis() + "car");
        ...
        Task<Uri> url = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            if (task.isSuccessful()) {
                ...
                hashMap.put("Pan_Image", DownloadImg.toString());
                ...
                hashMap1.put("title","Updated Character Certificate");
                ...
                DriverRef.updateChildren(hashMap).addOnSuccessListener(unused -> {
                    ...
                    Intent intent = new Intent(CarCerActivity.this, perference.class);
...
//                PickFromStorage();
    ...
    private boolean checkStoragePermission() {
        boolean result1 = ContextCompat.checkSelfPermission(CarCerActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        return result1;
    }
    ...
    private boolean checkCameraPermission() {
        boolean result = ContextCompat.checkSelfPermission(CarCerActivity.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);
        boolean result1 = ContextCompat.checkSelfPermission(CarCerActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        ...
        switch (requestCode){
            case CAMERA_REQUEST:{
                ...
                if(camera_accepted && storage_accepted){
                    ...
                    Toast.makeText(CarCerActivity.this, "No File is Selected", Toast.LENGTH_SHORT).show();
                }
            }
            break;
