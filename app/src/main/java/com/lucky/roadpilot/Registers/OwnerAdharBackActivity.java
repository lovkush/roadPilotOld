...
public class OwnerAdharBackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_adhar_back);
    ...
    private void saveID() {
        ...
        final StorageReference reference1 = storageReference.child(value).child(System.currentTimeMillis() + "adharB");
        ...
        Task<Uri> url = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            if (task.isSuccessful()) {
                ...
                hashMap.put("aadhar_b_Image", DownloadImg.toString());
                ...
                hashMap1.put("title","Updated Aadhar Card Back");
                ...
                DriverRef.updateChildren(hashMap).addOnSuccessListener(unused -> {
                    progressDialog.dismiss();
                        Intent intent = new Intent(OwnerAdharBackActivity.this, perference.class);
...
//                PickFromStorage();
    ...
    private boolean checkStoragePermission() {
        boolean result1 = ContextCompat.checkSelfPermission(OwnerAdharBackActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        return result1;
    }
    ...
    private boolean checkCameraPermission() {
        boolean result = ContextCompat.checkSelfPermission(OwnerAdharBackActivity.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);
        boolean result1 = ContextCompat.checkSelfPermission(OwnerAdharBackActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        ...
        switch (requestCode){
            case CAMERA_REQUEST:{
                ...
                if(camera_accepted && storage_accepted){
                    ...
                    Toast.makeText(OwnerAdharBackActivity.this, "No File is Selected", Toast.LENGTH_SHORT).show();
                }
            }
            break;
