...
public class DrivingLFActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driving_lfactivity);
    ...
    private void saveID() {
        ...
        final StorageReference reference1 = storageReference.child(value).child(System.currentTimeMillis() + "drivingf");
        ...
        Task<Uri> url = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            if (task.isSuccessful()) {
                ...
                hashMap.put("DrivingF_Image", DownloadImg.toString());
                ...
                hashMap1.put("title","Updated Driving Licence Front");
                ...
                DriverRef.updateChildren(hashMap).addOnSuccessListener(unused -> {
                    progressDialog.dismiss();
                        ...
                        Intent intent = new Intent(DrivingLFActivity.this, perference.class);
...
//                PickFromStorage();
    ...
    private boolean checkStoragePermission() {
        boolean result1 = ContextCompat.checkSelfPermission(DrivingLFActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        return result1;
    }
    ...
    private boolean checkCameraPermission() {
        boolean result = ContextCompat.checkSelfPermission(DrivingLFActivity.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);
        boolean result1 = ContextCompat.checkSelfPermission(DrivingLFActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        ...
        switch (requestCode){
            case CAMERA_REQUEST:{
                ...
                if(camera_accepted && storage_accepted){
                    ...
                    Toast.makeText(DrivingLFActivity.this, "No File is Selected", Toast.LENGTH_SHORT).show();
                }
            }
            break;
