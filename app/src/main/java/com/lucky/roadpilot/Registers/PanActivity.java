    ...
    private void saveID() {
        ...
        Task<Uri> url = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            if (task.isSuccessful()) {
                ...
                hashMap.put("PFan", DownloadImg.toString());
                ...
                hashMap1.put("title","Updated PAN Card");
                ...
                DriverRef.updateChildren(hashMap).addOnSuccessListener(unused -> {
                    progressDialog.dismiss();
                        ...
                        Intent intent = new Intent(PanActivity.this, perference.class);
...
//                PickFromStorage();
    ...
    private boolean checkStoragePermission() {
        boolean result1 = ContextCompat.checkSelfPermission(PanActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        return result1;
    }
    ...
    private boolean checkCameraPermission() {
        boolean result = ContextCompat.checkSelfPermission(PanActivity.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);
        boolean result1 = ContextCompat.checkSelfPermission(PanActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        ...
        switch (requestCode){
            case CAMERA_REQUEST:{
                ...
                if(camera_accepted && storage_accepted){
                    ...
                    Toast.makeText(PanActivity.this, "No File is Selected", Toast.LENGTH_SHORT).show();
                }
            }
            break;
