...
public class OwnerAdharFrontActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_adhar_front);
    ...
    private void saveID() {
        ...
        progressDialog.setMessage("Uploading Aadhar.....");
        progressDialog.show();

        final StorageReference reference1 = storageReference.child(value).child(System.currentTimeMillis() + "adharf");
        ...
        Task<Uri> url = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            if (task.isSuccessful()) {
                ...
                hashMap.put("aadhar_Img_f", DownloadImg.toString());
                ...
                hashMap1.put("title","Updated Aadhar Card Front");
                ...
                DriverRef.updateChildren(hashMap).addOnSuccessListener(unused -> {
                    ...
                    Intent intent = new Intent(OwnerAdharFrontActivity.this, perference.class);
...
//                PickFromStorage();
    ...
    private boolean checkStoragePermission() {
        boolean result1 = ContextCompat.checkSelfPermission(OwnerAdharFrontActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        return result1;
    }
    ...
    private boolean checkCameraPermission() {
        boolean result = ContextCompat.checkSelfPermission(OwnerAdharFrontActivity.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);
        boolean result1 = ContextCompat.checkSelfPermission(OwnerAdharFrontActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        ...
        switch (requestCode){
            case CAMERA_REQUEST:{
                ...
                if(camera_accepted && storage_accepted){
                    ...
                    Toast.makeText(OwnerAdharFrontActivity.this, "No File is Selected", Toast.LENGTH_SHORT).show();
                }
            }
            break;
